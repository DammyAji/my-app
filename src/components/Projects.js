...
const Projects = () => {
  return (
    <section className="p-6 bg-white" id= "projects">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className={`${styles.card} p-4`}>
          ...
          />
          <p className="text-black font-medium text-lg">Project Title 1</p>
        ...
        <div className={`${styles.card} p-4`}>
          <img 
            ...
            className="w-full h-48 object-cover rounded-xl mb-6" // Increased margin-bottom and border-radius
          />
          <p className="text-black font-medium text-lg">Project Title 2</p>
          <p className="text-black text-sm mt-4">
        ...
        <div className={`${styles.card} p-4`}>
          <img 
            ...
            className="w-full h-48 object-cover rounded-xl mb-6" // Increased margin-bottom and border-radius
          />
          <p className="text-black font-medium text-lg">Project Title 3</p>
          <p className="text-black text-sm mt-4">
        ...
        <div className={`${styles.card} p-4`}>
          <img 
            ...
            className="w-full h-48 object-cover rounded-xl mb-6" // Increased margin-bottom and border-radius
          />
          <p className="text-black font-medium text-lg">Project Title 4</p>
          <p className="text-black text-sm mt-4">
